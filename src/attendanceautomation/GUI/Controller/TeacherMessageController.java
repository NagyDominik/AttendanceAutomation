...
public class TeacherMessageController implements Initializable {
    ...
    /**
     * Set up a cellValue factory so that the correct date and name is
     * displayed.
     */
    ...
    /**
     * Override the updateItem() method, so that the unseen messages are
    ...
    /**
     * Set up a listener and a method to automatically change the labels to
     * reflect the contents of a newly selected message.
     */
